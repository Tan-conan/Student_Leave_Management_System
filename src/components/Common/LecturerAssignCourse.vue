...
const props = defineProps({
 ...
 lecturersList:{type:Array, default: []},
 selectedLecturer:{type:String, default: ''},
});

const emit = defineEmits(['assignLecturer','update:selectedCourse','update:selectedLecturer'])
